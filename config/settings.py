...
# CORS Configuration - Set before MIDDLEWARE definition
if DEBUG:
...
# Add WhiteNoise only in production (not in development)
if not DEBUG:
...
# Database
# Uses DATABASE_URL if provided (for production), otherwise SQLite (for development)
DATABASE_URL = os.getenv('DATABASE_URL')

if DATABASE_URL:
    # Parse DATABASE_URL for production (e.g., PostgreSQL, MySQL)
